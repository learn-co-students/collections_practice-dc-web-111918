...
describe 'collections practice' do
  ...
  describe '#swap_elements_from_to' do
    it 'swap index and destination index of an array' do
      expect(swap_elements_from_to(["blake", "ashley", "scott", "anthony", "katty", "gregory"], 1, -2)).to eq(["blake", "katty", "scott", "anthony", "ashley", "gregory"])
    end
  end
